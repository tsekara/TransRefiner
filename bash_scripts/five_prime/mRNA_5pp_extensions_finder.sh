...
do
  ...
  grep $scaffold $annotation | grep "gene" | grep $transcript | cut -f1,4,5,7,9  | awk '{OFS=FS="\t"}  {if($4 == "+") {print $1,$2,$2+1,$4,$5} else if($4 =="-") {print $1,$3-1,$3,$4,$5}}' - - > ./Transcript_Scaffold_bed_files/$transcript.bed
