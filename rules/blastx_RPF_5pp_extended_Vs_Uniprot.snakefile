rule BLAST_RPF_5pp_extended_fasta_vs_Uniprot:
     input:
        expand("{blastx_output_dir}/Grouped_blastx_RPF_5pp_extended_swissprot_trembl_max_target_3_evalue_0.001.txt",
...
rule do_blastX_5pp_extended_fasta:
    input:
        fasta=expand("{five_prime_extensions}/Extended_five_prime_extensions.fasta",
                                        five_prime_extensions=five_prime_extensions),
        protein_DB=expand("{Uniprot_dir}/Blastx_Uniprot_hits_seqs",
                                                            Uniprot_dir=Uniprot_dir)
    output:
        expand("{blastx_output_dir}/blastx_RPF_5pp_extended_swissprot_trembl_max_target_3_evalue_0.001.txt",
                                                            blastx_output_dir=blastx_output_dir)
    message:
        "BLASTX of 5pp extended transcripts against Uniprot Protein sequences of original transcripts"
    threads:
        20
    params:
        max_target_seqs=3,
...
rule do_Group_BLASThits_5pp_extended_fasta:
    input:
            blastx_5pp_extended_output=expand("{blastx_output_dir}/blastx_RPF_5pp_extended_swissprot_trembl_max_target_3_evalue_0.001.txt",
                                                                blastx_output_dir=blastx_output_dir),
