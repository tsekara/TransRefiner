# This locates the genomics location for all the 5pp incomplete transcripts including its
# genomic and transcriptomic strand incomplete_ids_orientation

rule five_pp_transcripts_genomic_location:
    input:
...
rule do_five_pp_transcripts_genomic_location:
    input:
